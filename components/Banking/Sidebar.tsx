/* components/Sidebar.tsx
   – added “My Applications” directly below “Investments”               */
   ...
   import {
     ...
     UserPlus,
     Clock,
     Hourglass,              // ← icon reused for the new link
     MailWarning,
     Banknote,
     Shield,
     TrendingUp,
               ...
               >
                 {collapsed ? (
                   <svg width={22} height={22} viewBox="0 0 20 20" fill="none">
                     <path d="M6 6L14 10L6 14V6Z" fill="#0056B6" />
                   </svg>
                 ) : (
                   <svg width={22} height={22} viewBox="0 0 20 20" fill="none">
                     <path d="M14 14L6 10L14 6V14Z" fill="#0056B6" />
                   </svg>
                 )}
               </button>
             </div>
