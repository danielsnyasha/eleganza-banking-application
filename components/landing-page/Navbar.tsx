            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-6">
                ...
                <div className="flex items-center gap-6">
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-bold tracking-wide text-[#00a0ff]">ELEGANZA</span>
                    </Link>
                ...
                <div className="hidden items-center gap-6 lg:flex">
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Call us on <strong>0800&nbsp;123&nbsp;456</strong> or email <strong>support@eleganza.bank</strong>.
                                </DialogDescription>
                            </DialogHeader>
                        </DialogContent>
                    </Dialog>
                    ...
                    <SignedIn>
  <SignOutButton>
    <Button size="sm" variant="outline" className="border-white/30 bg-transparent px-6 text-white hover:text-black hover:bg-white/40">
      Sign&nbsp;out
    </Button>
  </SignOutButton>
</SignedIn>
